 ...
 */
import { compress, decompress } from "./lossless/dictionary/lz77.js";
import { printBenchmark } from "./lossless/dictionary/benchmark.js";

// process.argv looks like: [node, "src/lz77.demo.js", <your string>, ...]
const input = process.argv[2] ?? "the cat sat on the mat";
